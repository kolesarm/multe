...
standard errors reported above. These can be accessed in the `est_f` component
of the output (or `est_o` for the overlap sample results)
...
Methods section below. Specifying the `cluster` argument allows for computation
